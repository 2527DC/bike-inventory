...
| `assembly-audit-build-line-plan.md` | — |
| `bin-tracking-dynamic-toggle-and-warehouse-directory-plan.md` | — |
| `ledger-merge-plan.md` | schema, RBAC, backend and the reconciliation engine shipped and still in use; its §7/§12 frontend (the three-tab BCH-styled screen and the `/ledger` list) was **superseded 9 Sep 2026** by `0909-vendor-ledger-screens-and-ai-import-plan.md`, which replaces the screen with the ledger app's own and builds the import, evidence and AI pieces this plan left open |
