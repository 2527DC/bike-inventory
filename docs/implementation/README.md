...
| Plan | State |
|---|---|
| `1609-deliveries-floor-warehouse-contact-and-self-fill-plan.md` | written 16 Sep 2026, nothing built. |
| `1709-priority-build-and-stock-flow-plan.md` | written 17 Sep 2026, **waiting for the owner's approval before any build**. |
| `2109-inbound-bins-navigation-fixes-plan.md` | written 21 Sep 2026, all questions answered, **waiting for the owner's go-ahead and base branch before any build**. Inbound bin mandatory + rule bin locked, bin-scoped audits create the `U-` codes, bin-count fix, bins always on, /inbound quick filters, inbound off /approvals. |
