...
const LOGIC_SECTIONS: LogicSection[] = [
  ...
  // ═══════════════════════════════════════════════════════════
  {
    ...
    entries: [
      ...
      { label: "Permission Check Flow", type: "rule", detail: "Client: usePermissions() hook → fetches GET /api/my-permissions → caches result. Returns canView/canCreate/canEdit/canDelete/canApprove/canFetch functions. Server: requireAuth(roles?) in API routes.", important: true },
